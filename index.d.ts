 ...
 * ```
 */
export function requiresAuth(requiresLoginCheck?: (req: OpenidRequest) => boolean): RequestHandler;
 ...
 * ```
 */
export function claimCheck(checkFn: (req: OpenidRequest, claims: IdTokenClaims) => boolean): RequestHandler;
