...
declare namespace Express {
  interface Request {
    /** session data alias, named by `session.name` config (default `appSession`) */
    appSession?: Record<string, any>;
    /** session data alias used by tests configuring `session.name: 'mySession'` */
    mySession?: Record<string, any>;
  }
}
